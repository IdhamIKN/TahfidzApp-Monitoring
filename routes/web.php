...
$router->group(['prefix' => 'parent'], function () use ($router) {
    ...
    $router->post('/kirim-otp', ['as'=>'kirim-otp','uses' => 'ParentController@kirimPesanWA']);
...
$router->group(['prefix' => 'absensi'], function () use ($router) {
	$router->get('/',  ['as'=>'absensi','uses' => 'AbsensiController@index']);
    // $router->get('/create', ['as'=>'create-absensi','uses' => 'AbsensiController@create']);
    $router->get('/create/{id}',  ['as'=>'create-absensi','uses' => 'AbsensiController@create']);
    // $router->get('/create',  ['as'=>'create-absensi','uses' => 'AbsensiController@create']);
	$router->post('/store',  ['as'=>'store-absensi','uses' => 'AbsensiController@store']);
	$router->get('/get-user-teacher',  ['as'=>'get-user-teacher','uses' => 'AbsensiController@getUserTeacher']);
	$router->post('/delete',  ['as'=>'delete-student-class','uses' => 'AbsensiController@delete']);
	$router->post('/get-detail',  ['as'=>'detail-student','uses' => 'AbsensiController@show']);
	$router->get('/update',  ['as'=>'update-absensi','uses' => 'AbsensiController@update']);
    $router->get('/absensi/edit{id}', ['as' => 'absensi.edit', 'uses' => 'AbsensiController@edit']);
    $router->post('/search', ['as' => 'search-absensi', 'uses' => 'AbsensiController@searchByDate']);

    $router->post('/check-absensi', ['as' => 'check-absensi', 'uses' => 'AbsensiController@check-absensi']);
    // $router::post('/check-absensi', [AbsensiController::class, 'checkAbsensi'])->name('check-absensi');
...
$router->group(['prefix' => 'assessment'], function () use ($router) {
    ...
    $router->get('/absensi/{type}',  ['as'=>'show-absensi','uses' => 'AssessmentController@absensi']);
    ...
    $router->get('/pay',  ['as'=>'pay','uses' => 'AssessmentController@pay']);
});
