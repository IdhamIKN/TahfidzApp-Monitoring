    ...
    <ul class="nav">
        ...
        <li class="<?= $active == 'assessment' ? 'active' : '' ?>">
            <a href="<?= URL::to('/assessment'); ?>">
                ...
                <p style="color: yellow">Data Santri</p>
            </a>
        </li>
        <li class="<?= $active == 'pembayaran' ? 'active' : '' ?>">
            <a href="<?= URL::to('assessment/pay'); ?>">
                <i class="pe-7s-wallet"></i>
                <p style="color: yellow">Pembayaran</p>
            </a>
        </li>
        @endif
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input disabled="true" type="text" class="form-control" value="" name="notification_message"
