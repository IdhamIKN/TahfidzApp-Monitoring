            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <li>
                    <a href="<?= URL::to('/notification'); ?>">
                        <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span>&nbsp Buat Notifikasi
                    </a>
                </li>

                @endif

                @if($user->account_type == User::ACCOUNT_TYPE_CREATOR || $user->account_type ==
                ...
                @if($user->account_type == User::ACCOUNT_TYPE_CREATOR || $user->account_type ==
                User::ACCOUNT_TYPE_ADMIN || $user->account_type ==
                User::ACCOUNT_TYPE_TEACHER)
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="glyphicon glyphicon-cog" aria-hidden="true"></span> Pengaturan <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                        @if($user->account_type == User::ACCOUNT_TYPE_CREATOR || $user->account_type == User::ACCOUNT_TYPE_ADMIN)
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <span class="glyphicon glyphicon-user" aria-hidden="true"></span> Profil <b class="caret"></b>
                    </a>
                    <ul class="dropdown-menu">
                            <li><a href="<?= URL::to('/profile'); ?>"><span class="glyphicon glyphicon-user" aria-hidden="true"></span> &nbsp Profile</a></li>
                            <li><a href="<?= URL::to('/'); ?>/auth/logout"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span> &nbsp Logout</a></li>
                    </ul>
                </li>
