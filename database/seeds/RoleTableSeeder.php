...
class RoleTableSeeder extends Seeder
{
    ...
    public function run()
    {
    	...
    	if($user != null)
    	{
            ...
            $role_ortu 		= Role::create(['name' => 'Orang Tua']);
            ...
            // Assign Default Permission to Teacher
            $role_ortu->givePermissionTo('index profile');
            $role_ortu->givePermissionTo('update profile');
            $role_ortu->givePermissionTo('change password');
    	}
    }
    ...
    */
    private function createPermission()
    {
        ...
        // ----------- Notification -----------------
        // Permission::create(['name' => 'index Ortu']);
        // Permission::create(['name' => 'view Ortu']);
    }
}
